...
if vstup == 0
    ...
    struktura.nastaveni.max_iter = 2500;
    ...
    struktura.sum = random('normal', 0, struktura.nastaveni.odchylka, struktura.nastaveni.pocet_radku, 1);
    
    startI = 1;
end

for i = startI:struktura.nastaveni.pocet_opakovani
    y_orig = struktura.A(:,:,i)*struktura.x_orig + struktura.sum;
